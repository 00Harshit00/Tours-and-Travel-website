  ...
  <div class="package">
	<div class="container">
		<div class="package-main">
			 <div class="pack-top">
			 	<h3> Famous Hotel In Himachal</h3>
			 </div>
  <?php	
include_once("connection.php");

$r=mysql_query("select * from hotel") or die(mysql_error());
	while($s=mysql_fetch_array($r))
{
 ?>  
      ...
      <h2><a href="fullhotel.php?a=<?php echo $s['location'] ?>"><?php echo $s['location']?></a></h2></b2>
      	<p><?php echo $s['name']?></p>
				</div>
