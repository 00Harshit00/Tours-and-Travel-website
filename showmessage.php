...
$r=mysql_query("select * from contact") or die(mysql_error());
	...
	?>
            <tr>
                ...
                <td  width="200"> <a href="deletemsg.php?a=<?php echo $s['id'] ?>"><img src="images/remove.png" alt="remove" /><br /></a> </td>
