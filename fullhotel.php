...
$r=mysql_query("select * from hotel where location='$a'") or die(mysql_error());
...
$r=mysql_query("select * from hotel where location='$a'") or die(mysql_error());
	...
	{
 ?>
<table border="3"   height='200%' width='90%'>
<tr class="text-center"><th>Price</th><th><?php echo $s['price']?></th></tr>
<tr class="text-center"><th>Day's</th><th><?php echo$s['location']?></th></tr>
<tr class="text-center" ><th >Vec</th><th><?php echo$s['name']?></th></tr>
<tr><th colspan="2"><a href="Bookinghotel.php?a=<?php echo$s['id']?>"><h3>Booking</h3></a></th></tr></table>
<?php
}
?></br></br>
...
<div class="cleaner"></div>
<div class="col_w410 rmb" style="height: 400px">
