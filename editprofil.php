...
<div class="col_w410 rmb">
			...
			<div id="contact_form">
                ...
                <form name="f" method="post" action="editprofile1.php" enctype="multipart/form-data" onSubmit="return validation2()">
                   
 <?php
$a=$_SESSION['user'];
include_once("connection.php");
$r=mysql_query("select * from reg where email='$a'")or die(mysql_error());
...
?>
                    ...
                    <input type="text"  name="t1" value="<?php echo $s['user'] ?>" class="input_field" onKeyUp="val1('user')"><span id="user"></span>
                    
                    <label for="email">Email Id:</label>
                    <input type="text" name="t2" value="<?php echo $s['email'] ?>" class="input_field" onKeyUp="val1('id')"><span id="id"></span>
                     
                     <label for="email">Password:</label>
                    <input type="password" name="t3" value="<?php echo $s['pwd'] ?>" class="input_field" onKeyUp="val1('pwd')"><span id="pwd"></span>
                    ...
                    <input type="text" name="t5" value="<?php echo $s['mobileno'] ?>" class="input_field" onKeyUp="val1('no')"><span id="no"></span>


                    
                     <label for="email">Address:</label>
                    <textarea name="t6" value="<?php echo $s['address'] ?>"   onKeyUp="val1('address')"></textarea><span id="address"></span>
