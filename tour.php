...
<div class="col_w410 rmb">
			...
			<div id="contact_form">
                <form method="post" name="contact" action="tour1.php" enctype="multipart/form-data">
                   

                    <label for="email">Heading:</label>
                    <input type="text"  name="t1" class="input_field" />

                    <label for="subject">Place Name:</label>
                    <input type="text"  name="t2" class="input_field" />
                    
                    
                     <label for="email">Price:</label>
                    <input type="text" name="t3" class="input_field" />

					<label for="email">Day's:</label>
                    <input type="text"  name="t4" class="input_field" />

					<label>Vec:</label>
                    <input type="text" name="t5" class="input_field" />
                    
                    
                    
                   
                    <label>image:</label>
                    <input type="file" name="t6"  class="input_field" />
