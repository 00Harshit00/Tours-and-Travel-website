...
<div class="abc">
  <div class="header">
	<div class="container">
  	...
  	<h1 align="center" style="font-size:50px">Add Tour</h1><br>
<div class="col_w410 rmb">
	        ...
	        $r=mysql_query("select * from addtour where id='$a'")or die (mysql_error());
			...
			?>
               ...
               <form  method="post" name="contact" action="update1.php" enctype="multipart/form-data" >
                   

                    <label for="email">Heading:</label>
                    <input type="text"  name="t1" class="input_field" value="<?php echo $s['heading']?>" />
					 
                    <label for="subject">Place Name:</label>
                    <input type="text"  name="t2" class="input_field" value="<?php echo $s['placename']?>" />
                    
                    
                     <label for="email">Price:</label>
                    <input type="text" name="t3" class="input_field" value="<?php echo $s['price']?>"/>

					<label for="email">Day's:</label>
                    <input type="text"  name="t4" class="input_field" value="<?php echo $s['days']?>"/>

					<label>Vec:</label>
                    <input type="text" name="t5" class="input_field" value="<?php echo $s['vec']?>"/>
                    
                    
                     <label>image:</label>
                    <input type="file" name="t6"  class="input_field" value="<?php echo $s['image']?>"/>
