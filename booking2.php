...
include_once("connection.php");
	...
	if(mysql_num_rows($r)>0){
		...
		while($s=mysql_fetch_array($r)){
			...
			$eday=$s['eday'];
			$pid=$s['pid'];
		$r1=mysql_query("select * from hotel where Id='$pid'")or die(mysql_error());
  ...
  <div class="header">
	...
	?>
            <tr>
                ...
                <td  width="200"> <a href="remove1.php?a=<?php echo $s['id'] ?>"><img src="images/remove.png" alt="remove" /><br />Remove</a> </td>
	...
	?>    
        ...
        <p class="right"><a href="checkout2.php" class="button">checkout</a></p>
